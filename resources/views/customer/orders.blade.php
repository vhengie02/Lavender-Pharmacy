...
@section('content')
    <div class="mx-auto max-w-7xl px-4 pb-16 pt-24 sm:px-6 lg:px-8">
        <h1 class="font-serif text-3xl font-bold text-foreground">My orders</h1>
                        ...
                        <tbody class="divide-y divide-border">
                            @foreach ($orders as $order)
                                <tr>
                                    ...
                                    <td class="px-4 py-3">
                                        <a href="{{ route('orders.show', $order) }}" class="text-sm font-medium text-primary hover:underline">View</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
