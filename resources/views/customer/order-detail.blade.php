        ...
        <div class="mt-10 grid gap-8 lg:grid-cols-3">
            ...
            <div class="space-y-6">
                ...
                <div class="rounded-xl border border-border bg-card p-6 shadow-sm">
                    ...
                    @endif
                    <a href="{{ route('orders.index') }}" class="block w-full rounded-lg border border-border py-2.5 text-center text-sm font-medium hover:bg-secondary">Back to orders</a>
                </div>
            </div>
        </div>
    </div>
