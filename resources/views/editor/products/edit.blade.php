...
@section('title', 'Edit Product - Lavender Pharmacy')

@section('content')
<div class="row mb-4">
    <div class="col-md-12">
        <h1 style="color: #5D3A66;"><i class="fas fa-edit"></i> Edit Product</h1>
    </div>
</div>
...
<div class="row">
    <div class="col-md-8">
        <div class="card shadow-sm">
            <div class="card-body">
                <form action="{{ route('editor.products.update', $product) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('dosage_info') is-invalid @enderror" 
                               id="dosage_info" name="dosage_info" placeholder="e.g., 500mg" value="{{ old('dosage_info', $product->dosage_info) }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control @error('expiration_date') is-invalid @enderror" 
                                   id="expiration_date" name="expiration_date" value="{{ old('expiration_date', $product->expiration_date?->format('Y-m-d')) }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        @if($product->product_image)
                            <div class="mb-2">
                                <img src="{{ asset('uploads/' . $product->product_image) }}" alt="{{ $product->product_name }}" style="max-width: 200px; max-height: 200px;">
                        ...
                        <small class="text-muted">Max size: 2MB. Accepted formats: JPEG, PNG, JPG, GIF (leave empty to keep current image)</small>
    ...
    <div class="col-md-4">
        <div class="card shadow-sm bg-light mb-3">
            <div class="card-body">
                <h5 style="color: #B57EDC;">📊 Product Info</h5>
                <ul class="small mb-0">
                    <li><strong>Created:</strong> {{ $product->date_added?->format('M d, Y H:i') ?? 'N/A' }}</li>
                    <li><strong>Last Updated:</strong> {{ $product->date_updated?->format('M d, Y H:i') ?? 'N/A' }}</li>
        ...
        <div class="card shadow-sm bg-light">
            <div class="card-body">
                ...
                <ul class="small">
                    ...
                    <li>You can update individual fields</li>
